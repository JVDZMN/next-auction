...
interface CarsResponse { cars: CarListing[]; total: number; page: number; pageSize: number; totalPages: number }
...
export default function CarsPage() {
  ...
  }, [brand, model, city, fuel, bodyType, minPrice, maxPrice, minYear, maxYear, kmRange, synStatus, likedOnly, sortBy, page, locale])
  ...
  // Derived labels for Select displays — Base UI Select.Value shows raw value
  // until the popup is opened; passing explicit children avoids this.
