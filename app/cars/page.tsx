...
const FUEL_OPTIONS = ['Benzin', 'Diesel', 'HybridBenzin', 'HybridDiesel', 'PluginHybrid', 'Electric']
const SORT_OPTIONS = [
...
export default function CarsPage() {
  ...
  }, [brand, model, city, fuel, bodyType, minPrice, maxPrice, minYear, maxYear, likedOnly, sortBy, page])
  ...
  // Push current filters to URL for shareability
  useEffect(() => {
    const params = buildParams()
    const qs = new URLSearchParams(params).toString()
    router.replace(`/cars?${qs}`, { scroll: false })
  }, [brand, model, city, fuel, bodyType, minPrice, maxPrice, minYear, maxYear, likedOnly, sortBy, page])
